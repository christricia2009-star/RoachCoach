...
final class APIKeyStore: ObservableObject {
    ...
    func clearAll() {
        let all = [Keys.backendURL, Keys.openRouter, Keys.xAI, Keys.anthropic, Keys.instagram, Keys.xBearer, Keys.partnership, Keys.partnershipURL,
                   Keys.municipalToken, Keys.municipalURL, Keys.telecom, Keys.telecomURL, Keys.uberID, Keys.uberSecret, Keys.uberURL,
                   Keys.doorDash, Keys.doorDashURL, Keys.s3Bucket, Keys.awsAccess, Keys.awsSecret, Keys.llmStrategy, Keys.llmProvider, Keys.llmModel]
        all.forEach(Self.delete)
        backendURL = ""; openRouterKey = ""; xAIKey = ""; anthropicKey = ""; instagramToken = ""; xBearerToken = ""; partnershipKey = ""; partnershipURL = ""
        municipalAppToken = ""; municipalDatasetURL = ""; telecomKey = ""; telecomURL = ""; uberClientID = ""; uberClientSecret = ""; uberURL = ""
        doorDashKey = ""; doorDashURL = ""; s3BucketName = ""; awsAccessKey = ""; awsSecretKey = ""; llmStrategy = "fallback"; llmProvider = "anthropic"; llmModel = ""
    }
